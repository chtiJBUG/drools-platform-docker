...
RUN  /etc/init.d/postgresql start && psql -f /tmp/create_guvnor_user.sql && psql guvnor  < /home/guvnor/guvnor.dump && psql -f /tmp/create_platform_user.sql && psql -f /tmp/create_guvnor_security.sql  && psql --dbname=security -f /tmp/init_guvnor_security.sql 
