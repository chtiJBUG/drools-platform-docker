...
class tomcat7::install ($designer, $drools_guvnor, $guvnor_source, $designer_source, $drools_platform, $drools_platform_source) {
  ...
  # creates directory /home/guvnor
  file { "/home/$postgresql::install::guvnor/myconfig":
    ensure  => directory,
    owner   => 'tomcat7',
    mode    => '0664',
  ...
  file { "/home/$postgresql::install::guvnor/myconfig/jpa.properties": # creates file
    ensure  => present,
    owner   => 'tomcat7',
    mode    => '0664',
    source  => "puppet:///modules/tomcat7/jpa.properties",
    require => File["/home/$postgresql::install::guvnor/myconfig"],
  }

  file { "/home/$postgresql::install::guvnor/myconfig/platform-server.properties": # creates file
    ensure  => present,
    owner   => 'tomcat7',
    mode    => '0664',
    source  => "puppet:///modules/tomcat7/platform-server.properties",
    require => File["/home/$postgresql::install::guvnor/myconfig"],
  }

  file { "/home/$postgresql::install::guvnor/myconfig/runtime-topology.properties": # creates file
    ensure  => present,
    owner   => 'tomcat7',
    mode    => '0664',
    source  => "puppet:///modules/tomcat7/runtime-topology.properties",
    require => File["/home/$postgresql::install::guvnor/myconfig"],
  }
